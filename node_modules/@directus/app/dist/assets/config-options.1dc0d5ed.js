...
`)],-1),oe=l("h3",{id:"example%3A-redis"},[e("Example: Redis "),l("a",{class:"header-anchor",href:"#example%3A-redis"},"#")],-1),ue=l("pre",null,[l("code",null,`RATE_LIMITER_ENABLED="true"
...
`)],-1),Yn=l("h3",{id:"example%3A-multiple-auth-providers"},[e("Example: Multiple Auth Providers "),l("a",{class:"header-anchor",href:"#example%3A-multiple-auth-providers"},"#")],-1),Kn=l("p",null,"You can configure multiple providers for handling authentication in Directus. This allows for different options when logging in. To do this, you can provide a CSV of provider names, and provide a config block for each of them:",-1),zn=l("pre",null,[l("code",null,`AUTH_PROVIDERS="google,adobe"
